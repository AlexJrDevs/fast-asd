import sys, time, os, tqdm, torch, glob, subprocess, warnings, cv2, pickle, numpy, math, python_speech_features, gdown
...
if LOCAL_MACHINE:
	...
	if not os.path.exists(pretrained_model_path):
		# Download the file
		gdown.download("https://drive.google.com/uc?id=1J-PDWDAkYCdT8T2Nxn3Q_-iOHH_t-9YP", pretrained_model_path, quiet=False)
