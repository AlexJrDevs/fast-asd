...
class VideoTalkingTracker:
    ...
    def run_yolov8(self, file, confidence_threshold, start_frame, end_frame, models, fps, max_num_boxes):
        return self.yolov8_instance.__predict__(
            file=file,
    ...
    def run_talknetasd(self, file, start_time, end_time, face_boxes):
        detection_results = self.talknet_instance.__predict__(
            video=file,
    ...
    def push_video_segments_to_object_detection(self, video_segment, file, frame_interval=600, models="yolov8l, yolov8l-face", processing_fps=2):
    ...
    def get_active_speakers(self, speaker_frames, alpha=0.5, score_threshold=0):
    ...
    def process(
        ...
        def object_detection_wrapper(original_video, file, result_queue, frame_interval):
            ...
            result = self.push_video_segments_to_object_detection(original_video, file, frame_interval=frame_interval, models=models, processing_fps=processing_fps)
            result_queue.put(result)
